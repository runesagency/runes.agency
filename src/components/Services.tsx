                ...
                {services.map(({ color, icon: Icon }, i) => {
                    ...
                    return (
                        <button
                            ref={setBlockRef}
                            key={i}
                            className="flex w-full max-w-sm shrink-0 flex-col items-start justify-between gap-4 p-10 font-mulish text-black md:aspect-square md:max-w-md lg:aspect-auto lg:gap-8 xl:aspect-square xl:max-w-lg"
