    ...
    [
        {
            ...
            items: [
                ...
                },
                {
                    type: "portfolio",
                    title: "Runes V2",
                    description: "Old Instagram @runesagency (previously @runes.asia) posts",
                    url: "https://www.instagram.com/runesagency/",
                    imageUrl: "runes-v2.png",
                    imagePosition: "left bottom",
                    backgroundColor: theme.colors.blue.light,
                },
            ],
...
export default function Portfolio() {
    ...
    return (
        <section ref={elementRef} className="flex flex-col items-center gap-20 bg-green py-20" style={{ "--tw-bg-opacity": intersectionRatio } as React.CSSProperties}>
